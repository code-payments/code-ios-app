...
struct AccountSelectionScreen: View {
    ...
    @State private var accounts: [HistoricalAccountContainer] = []
...
//    }
    ...
    private func fetchAccounts() {
        ...
        .map {
            HistoricalAccountContainer(details: $0)
        }.filter {
    ...
    private func update(owner: PublicKey, handler: @MainActor (inout HistoricalAccountContainer) -> Void) {
...
@MainActor
class HistoricalAccountContainer: Identifiable {
