...
//    }
    ...
    func transfer(amount: KinAmount, fee: Kin, additionalFees: [Fee], rendezvous: PublicKey, destination: PublicKey, withdrawal: Bool = false, tipAccount: TipAccount? = nil, chatID: ChatID? = nil) async throws {
