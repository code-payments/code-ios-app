...
extension Font {
    ...
    public static let appDisplayXS:     Font = .default(size: 20, weight: .medium)
    ...
    public static let appTextMedium:    Font = .default(size: 16, weight: .medium)
    public static let appTextSmall:     Font = .default(size: 14, weight: .medium)
    public static let appTextBody:      Font = .default(size: 16, weight: .regular)
    public static let appTextHeading:   Font = .default(size: 12, weight: .medium)
    public static let appTextCaption:   Font = .default(size: 12, weight: .medium)
    
    public static let appTextAccessKey: Font = .default(size: 9, weight: .medium)
...
extension UIFont {
    ...
    public static let appDisplayXS:     UIFont = .default(size: 20, weight: .regular)
    ...
    public static let appTextMedium:    UIFont = .default(size: 16, weight: .medium)
    public static let appTextSmall:     UIFont = .default(size: 14, weight: .medium)
    public static let appTextBody:      UIFont = .default(size: 16, weight: .regular)
    public static let appTextHeading:   UIFont = .default(size: 12, weight: .medium)
    public static let appTextCaption:   UIFont = .default(size: 12, weight: .medium)
    
    public static let appTextAccessKey: UIFont = .default(size: 9, weight: .medium)
