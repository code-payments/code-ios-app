...
public struct Flipchat_Chat_V1_GetChatsRequest {
  ...
  public var account: Flipchat_Common_V1_UserId {
    get {return _account ?? Flipchat_Common_V1_UserId()}
...
extension Flipchat_Chat_V1_StreamChatEventsResponse.ChatUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "last_message"),
    4: .same(proto: "pointer"),
    5: .standard(proto: "is_typing"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._lastMessage) }()
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._pointer) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._isTyping) }()
        default: break
        }
      }
    }
