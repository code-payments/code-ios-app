...
public struct Ocp_Account_V1_TokenAccountInfo: @unchecked Sendable {
  ...
  public var mintMetadata: Ocp_Currency_V1_Mint {
    get {return _storage._mintMetadata ?? Ocp_Currency_V1_Mint()}
    set {_uniqueStorage()._mintMetadata = newValue}
  }
  /// Returns true if `mintMetadata` has been explicitly set.
  public var hasMintMetadata: Bool {return _storage._mintMetadata != nil}
  ...
  public var liveReserveState: Ocp_Currency_V1_VerifiedLaunchpadCurrencyReserveState {
    get {return _storage._liveReserveState ?? Ocp_Currency_V1_VerifiedLaunchpadCurrencyReserveState()}
    set {_uniqueStorage()._liveReserveState = newValue}
  }
  /// Returns true if `liveReserveState` has been explicitly set.
  public var hasLiveReserveState: Bool {return _storage._liveReserveState != nil}
