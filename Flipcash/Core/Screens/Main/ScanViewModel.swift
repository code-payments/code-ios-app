...
class ScanViewModel {
    ...
    /// Frame extraction runs only while no bill is presented — the camera and
    /// live preview keep running; only the per-frame scan work stops.
    func reconcileFrameExtraction() {
