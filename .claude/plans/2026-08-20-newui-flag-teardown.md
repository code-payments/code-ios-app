...
- XCUITests: `GiveDiscoverGateRegressionTests` was deleted (the gate it asserts is
  unreachable); `CurrencySellRegressionTests` became `CurrencyConvertRegressionTests`.
  The rest stay behind `skipPendingTabBarRewrite` — see `2026-08-20-ui-test-tab-bar-rewrite.md`.
