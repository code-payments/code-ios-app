...
public struct Code_Transaction_V2_GetPrivacyUpgradeStatusResponse {
  ...
  public enum Status: SwiftProtobuf.Enum {
    ...
    case temporaryActionFinalized // = 1
    ...
    public init?(rawValue: Int) {
      switch rawValue {
      case 0: self = .unknown
      case 1: self = .temporaryActionFinalized
    ...
    public var rawValue: Int {
      switch self {
      case .unknown: return 0
      case .temporaryActionFinalized: return 1
...
/// payment types
public struct Code_Transaction_V2_ExtendedPaymentMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Code_Transaction_V2_SendPublicPaymentMetadata {
  ...
  public var extendedMetadata: Code_Transaction_V2_ExtendedPaymentMetadata {
    get {return _extendedMetadata ?? Code_Transaction_V2_ExtendedPaymentMetadata()}
    set {_extendedMetadata = newValue}
  }
  /// Returns true if `extendedMetadata` has been explicitly set.
  public var hasExtendedMetadata: Bool {return self._extendedMetadata != nil}
  /// Clears the value of `extendedMetadata`. Subsequent reads from it will return its default value.
  public mutating func clearExtendedMetadata() {self._extendedMetadata = nil}
  ...
  fileprivate var _destination: Code_Common_V1_SolanaAccountId? = nil
  fileprivate var _exchangeData: Code_Transaction_V2_ExchangeData? = nil
  fileprivate var _extendedMetadata: Code_Transaction_V2_ExtendedPaymentMetadata? = nil
}
...
extension Code_Transaction_V2_ExtendedPaymentMetadata: @unchecked Sendable {}
...
extension Code_Transaction_V2_GetPrivacyUpgradeStatusResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNKNOWN"),
    1: .same(proto: "TEMPORARY_ACTION_FINALIZED"),
...
extension Code_Transaction_V2_ExtendedPaymentMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ExtendedPaymentMetadata"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "value"),
  ]
  ...
  public static func ==(lhs: Code_Transaction_V2_ExtendedPaymentMetadata, rhs: Code_Transaction_V2_ExtendedPaymentMetadata) -> Bool {
...
extension Code_Transaction_V2_SendPublicPaymentMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "exchange_data"),
    3: .standard(proto: "is_withdrawal"),
    5: .standard(proto: "extended_metadata"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._extendedMetadata) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._extendedMetadata {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Code_Transaction_V2_SendPublicPaymentMetadata, rhs: Code_Transaction_V2_SendPublicPaymentMetadata) -> Bool {
    ...
    if lhs._exchangeData != rhs._exchangeData {return false}
    if lhs.isWithdrawal != rhs.isWithdrawal {return false}
    if lhs._extendedMetadata != rhs._extendedMetadata {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
