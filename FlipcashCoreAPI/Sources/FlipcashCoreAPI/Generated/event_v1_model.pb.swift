...
public struct Flipcash_Event_V1_EventId {
...
public struct Flipcash_Event_V1_Event {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Flipcash_Event_V1_Event.OneOf_Type, rhs: Flipcash_Event_V1_Event.OneOf_Type) -> Bool {
      ...
      case (.poolResolved, .poolResolved): return {
        guard case .poolResolved(let l) = lhs, case .poolResolved(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.poolBetUpdate, .poolBetUpdate): return {
        guard case .poolBetUpdate(let l) = lhs, case .poolBetUpdate(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct Flipcash_Event_V1_EventBatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Flipcash_Event_V1_UserEvent {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Flipcash_Event_V1_UserEventBatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Flipcash_Event_V1_TestEvent {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Flipcash_Event_V1_PoolResolvedEvent {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Flipcash_Event_V1_PoolBetUpdateEvent {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Flipcash_Event_V1_ClientPong {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Flipcash_Event_V1_EventId: @unchecked Sendable {}
extension Flipcash_Event_V1_Event: @unchecked Sendable {}
extension Flipcash_Event_V1_Event.OneOf_Type: @unchecked Sendable {}
extension Flipcash_Event_V1_EventBatch: @unchecked Sendable {}
extension Flipcash_Event_V1_UserEvent: @unchecked Sendable {}
extension Flipcash_Event_V1_UserEventBatch: @unchecked Sendable {}
extension Flipcash_Event_V1_TestEvent: @unchecked Sendable {}
extension Flipcash_Event_V1_PoolResolvedEvent: @unchecked Sendable {}
extension Flipcash_Event_V1_PoolBetUpdateEvent: @unchecked Sendable {}
extension Flipcash_Event_V1_ServerPing: @unchecked Sendable {}
extension Flipcash_Event_V1_ClientPong: @unchecked Sendable {}
...
extension Flipcash_Event_V1_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .same(proto: "ts"),
    3: .same(proto: "test"),
    100: .standard(proto: "pool_resolved"),
    101: .standard(proto: "pool_bet_update"),
  ]
...
extension Flipcash_Event_V1_PoolResolvedEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "pool"),
    2: .standard(proto: "bet_summary"),
    3: .standard(proto: "user_summary"),
  ]
