...
public struct Flipcash_Email_V1_EmailAddress {
...
public struct Flipcash_Email_V1_VerificationCode {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Flipcash_Email_V1_EmailAddress: @unchecked Sendable {}
extension Flipcash_Email_V1_VerificationCode: @unchecked Sendable {}
