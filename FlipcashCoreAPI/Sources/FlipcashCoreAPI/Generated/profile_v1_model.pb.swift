...
public struct Flipcash_Profile_V1_UserProfile {
...
public struct Flipcash_Profile_V1_SocialProfile {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Flipcash_Profile_V1_SocialProfile.OneOf_Type, rhs: Flipcash_Profile_V1_SocialProfile.OneOf_Type) -> Bool {
...
public struct Flipcash_Profile_V1_XProfile {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Flipcash_Profile_V1_XProfile.VerifiedType: CaseIterable {
...
extension Flipcash_Profile_V1_UserProfile: @unchecked Sendable {}
extension Flipcash_Profile_V1_SocialProfile: @unchecked Sendable {}
extension Flipcash_Profile_V1_SocialProfile.OneOf_Type: @unchecked Sendable {}
extension Flipcash_Profile_V1_XProfile: @unchecked Sendable {}
extension Flipcash_Profile_V1_XProfile.VerifiedType: @unchecked Sendable {}
