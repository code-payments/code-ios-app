//
//  TimelockProgram.CloseAccounts.swift
//  CodeServices
//
...
extension TimelockProgram {
    public struct CloseAccounts: Equatable, Hashable, Codable {
...
extension TimelockProgram.CloseAccounts: InstructionType {
    
    public init(instruction: Instruction) throws {
        var data = try TimelockProgram.parse(.closeAccounts, instruction: instruction, expectingAccounts: 6)
    ...
    public func encode() -> Data {
        ...
        data.append(contentsOf: TimelockProgram.Command.closeAccounts.rawValue.bytes)
