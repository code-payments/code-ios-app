...
class ChatController: ObservableObject {
    ...
    func send(content: Chat.Content, in chat: Chat) async throws -> Chat.Message {
    ...
    private func sendMessage(in chatID: ChatID, content: Chat.Content) async throws -> Chat.Message {
