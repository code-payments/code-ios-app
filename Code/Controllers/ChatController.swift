...
class ChatController: ObservableObject {
    ...
    func send(content: ChatLegacy.Content, in chat: ChatLegacy) async throws -> ChatLegacy.Message {
        try await sendMessage(in: chat.id, content: content)
    }
    ...
    private func sendMessage(in chatID: ChatID, content: ChatLegacy.Content) async throws -> ChatLegacy.Message {
