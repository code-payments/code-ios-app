...
extension CurrencyCreatorProgram {
    ...
    /// 6. `[writable]` Buyer base (buyer's base token account)
...
extension CurrencyCreatorProgram.BuyAndDepositIntoVm: InstructionType {
    ...
    public init(instruction: Instruction) throws {
        let data = try CurrencyCreatorProgram.parse(.buyAndDepositIntoVm, instruction: instruction, expectingAccounts: 14)
        ...
        self.init(
            ...
            buyerBase: instruction.accounts[6].publicKey,
