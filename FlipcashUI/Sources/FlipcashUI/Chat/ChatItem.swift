...
/// A single rendered row in the transcript: a message bubble, a centered date header, or a read
/// receipt. A separator carries no sender or grouping, so it's a distinct case rather than a
/// message with unused fields. The whole transcript is driven by `[ChatItem]`.
