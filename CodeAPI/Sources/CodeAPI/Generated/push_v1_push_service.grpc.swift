...
public protocol Code_Push_V1_PushClientInterceptorFactoryProtocol: GRPCSendable {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
public protocol Code_Push_V1_PushAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Code_Push_V1_PushServerInterceptorFactoryProtocol? { get }
  ...
  public func handle(
    ...
    case "AddToken":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Code_Push_V1_AddTokenResponse>(),
        interceptors: self.interceptors?.makeAddTokenInterceptors() ?? [],
        wrapping: self.addToken(request:context:)
      )
...
public protocol Code_Push_V1_PushServerInterceptorFactoryProtocol {
