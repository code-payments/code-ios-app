...
extension Code_Messaging_V1_MessagingClientProtocol {
  ...
  ///
  /// Only RequestToGrabBill, RequestToReceiveBill, RequestToLogin are supported for real time events.
  ///
  ...
  ///      public key, which is derived by using sha256(scan_payload) as the keypair seed.
  ///   2. The third party calls `OpenMessageStream` on the rendezvous public key to listen
